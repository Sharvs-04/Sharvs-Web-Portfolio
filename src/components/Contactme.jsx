...
const ContactForm = () => {
  ...
  return (
    <section className="relative py-12 px-4 sm:py-16 sm:px-6 lg:py-24 lg:px-32 bg-gradient-to-b from-neutral-950 to-neutral-900 text-neutral-300">
      <div className="flex flex-col lg:flex-row gap-8 lg:gap-20 items-start justify-between">
        ...
        <motion.div
          ...
          className="w-full lg:w-1/2 bg-neutral-900 p-6 sm:p-8 md:p-10 rounded-3xl shadow-xl backdrop-blur-sm border border-neutral-700"
        >
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-extrabold text-white mb-6 sm:mb-8">
            Let's Connect! <span className="text-blue-500">Reach Out</span>
          </h2>

          <p className="mb-3 flex items-center gap-3 text-base sm:text-lg hover:text-blue-400 transition-colors">
          ...
          <p className="mb-3 flex items-center gap-3 text-base sm:text-lg hover:text-green-400 transition-colors">
            <FaPhone className="w-5 h-5" /> 
            <a href="tel:+639062698915">+63 906 269 8915</a>
          </p>

          <p className="flex items-center gap-3 text-base sm:text-lg hover:text-red-400 transition-colors">
        ...
        <motion.div
          ...
          className="w-full lg:w-1/2 bg-neutral-900 p-6 sm:p-8 md:p-10 rounded-3xl shadow-xl backdrop-blur-sm border border-neutral-700"
        >
          <h3 className="text-xl sm:text-2xl md:text-3xl font-semibold text-white mb-5 sm:mb-6">Send me a message</h3>
          ...
          <form ref={form} onSubmit={sendEmail} className="flex flex-col space-y-4 sm:space-y-5">
            ...
            <textarea
              ...
              className="w-full px-4 py-3 rounded-lg bg-neutral-800 border border-neutral-700 focus:ring-2 focus:ring-blue-500 focus:border-transparent text-white placeholder:text-neutral-400 transition resize-none"
              required
            ></textarea>
